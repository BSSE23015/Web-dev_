...
app.put("/jokes/:id", (req, res) => {
  const to_id = parseInt(req.params.id);
  const editedJoke = {
    id: to_id,
    jokeType: req.body.jokeType, // use correct key
    jokeText: req.body.jokeText, // use correct key
  };
  let index = jokes.findIndex((joke) => joke.id === to_id);
...
app.patch("/jokes/:id", (req, res) => {
  const id = parseInt(req.params.id);
  let sel_joke = jokes.find((joke) => joke.id === id);
  if (!sel_joke) {
  ...
  const new_joke = {
    id: id,
    jokeType: req.body.jokeType || sel_joke.jokeType,
    jokeText: req.body.jokeText || sel_joke.jokeText,
  };
...
app.delete("/jokes/:id", (req, res) => {
  ...
  let searchedIndex = jokes.findIndex((joke) => joke.id === id);
  if (searchedIndex > -1) {
